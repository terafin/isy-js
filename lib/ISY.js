...
exports.ElkAlarmSensorDevice = ElkAlarmSensorDevice_1.ElkAlarmSensorDevice;
...
exports.InsteonKeypadRelayDevice = InsteonKeypadRelayDevice_1.InsteonKeypadRelayDevice;
const InsteonKeypadDimmerDevice_1 = require("./Devices/Insteon/InsteonKeypadDimmerDevice");
exports.InsteonKeypadDimmerDevice = InsteonKeypadDimmerDevice_1.InsteonKeypadDimmerDevice;
...
class ISY extends events_1.EventEmitter {
    ...
    async loadFolders(result) {
        ...
        if ((_b = (_a = result) === null || _a === void 0 ? void 0 : _a.nodes) === null || _b === void 0 ? void 0 : _b.folder) {
        ...
        parser.parseString(event.data, (err, res) => {
            ...
            switch (stringControl) {
                ...
                case Families_1.EventType.Heartbeat.toString():
                    this.logger.debug(`Received ${Families_1.EventType[Number(stringControl)]} Signal from ISY: ${JSON.stringify(evt)}`);
                    break;
                default:
                    if (evt.node !== '' && evt.node !== undefined && evt.node !== null) {
                        ...
                        if (impactedDevice !== undefined && impactedDevice !== null) {
                            ...
                            this.logger.warn(Families_1.EventType[Number(stringControl)] + ' Event for Unidentified Device: ' + JSON.stringify(evt));
                        }
                    }
                    else {
                        if (stringControl === Families_1.EventType.NodeChanged.toString()) {
